...
|------------|------|---------|------|---------|
| アーキテクチャ設計書 | システム全体の設計方針 | 初期作成後、主要変更時 | Markdown | `/docs/03_詳細設計/01_アーキテクチャ/` |
| モジュール設計書 | 機能モジュールの設計 | 機能実装時・主要変更時 | Markdown | `/docs/03_詳細設計/02_モジュール/` |
| API仕様書 | 外部公開APIの仕様 | 継続的に自動生成 | OpenAPI | `/docs/03_詳細設計/04_API/` |
| データベース設計補足 | 基本設計のDB定義に対する補足 | 必要に応じて | Markdown | `/docs/03_詳細設計/03_DB/` |
| アーキテクチャ決定記録 | 重要な設計決定の記録 | 設計決定時 | Markdown | `/docs/03_詳細設計/08_ADR/` |
...
| セキュリティ実装詳細 | 高セキュリティ要件のある機能 | Markdown | `/docs/03_詳細設計/05_セキュリティ/` |
| パフォーマンス対策設計 | 性能要件が厳しい機能 | Markdown | `/docs/03_詳細設計/07_パフォーマンス/` |
| 外部連携設計 | 外部システムとの連携がある場合 | Markdown | `/docs/03_詳細設計/04_API/外部連携API.md` |
...
- ADR：[/docs/03_詳細設計/08_ADR/adr-002-Spring-Data-JDBC採用.md](/docs/03_詳細設計/08_ADR/adr-002-Spring-Data-JDBC採用.md)
```
...
- リポジトリ内の`/docs/03_詳細設計`ディレクトリでドキュメントを管理
